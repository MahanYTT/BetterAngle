...
- **Updater Release Stream Fix**: Changed [`.github/workflows/msbuild.yml`](.github/workflows/msbuild.yml:114) so pushes to [`main`](.github/workflows/msbuild.yml:115) publish a normal stable `v<version>` release instead of a `ci-*` prerelease, matching the updater lookup against [`releases/latest`](src/shared/Updater.cpp:15).
