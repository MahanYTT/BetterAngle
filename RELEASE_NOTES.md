Generating release notes from commit range: v4.27.282..HEAD ### BetterAngle Pro v4.27.341
- fix: perfectly synchronize HUD with loading screen and launch v4.27.340
- fix: revert to immediate HUD show to ensure reliability and launch v4.27.330
