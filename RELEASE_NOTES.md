Generating release notes from commit range: v5.0.110..HEAD ### BetterAngle Pro v5.1.25
- release: BetterAngle Pro v5.1.24 (Official Deep-Freeze Forensic Suite)
- feat: implemented Deep-Freeze forensic diagnostics (v5.1.24)
- chore: auto-increment version for release
- fix: implemented Iron Flush and resolved permanent ghosting (v5.1.23)
- chore: auto-increment version for release
- feat: unified Iron-Tight diagnostics across UI (v5.1.22)
- chore: auto-increment version for release
- fix: resolved g_running linker conflict (v5.1.21)
- chore: auto-increment version for release
- fix: removed redundant key definition (v5.1.20)
- feat: implemented Iron-Tight diagnostic suite (v5.1.19)
- chore: auto-increment version for release
- fix: resolved compilation apocalypse (v5.1.18)
- chore: auto-increment version for release
- feat: implemented Absolute Truth diagnostics (v5.1.17)
- chore: auto-increment version for release
- fix: implemented Atomic Shield thread-safe polling (v5.1.16)
- chore: auto-increment version for release
- feat: implemented On-Screen Ghost Radar and synced versions (v5.1.15)
- chore: auto-increment version for release
- fix: resolved LNK2005 multiply defined symbols (v5.1.14)
- chore: auto-increment version for release
- fix: resolved g_nitroSyncLog build error (v5.1.13)
- chore: auto-increment version for release
- feat: implemented Ghost Detector Final Form with Phys/Tracked comparison (v5.1.12)
- chore: auto-increment version for release
- feat: added X-Ray Input Monitor for real-time ghosting diagnostics (v5.1.11)
- chore: auto-increment version for release
- chore: consolidated all versioning to v5.1.10
- chore: auto-increment version for release
- feat: enabled high-performance 1ms timers for polling thread (v5.1.8)
- chore: auto-increment version for release
- docs: added technical summary of nitro sync logic
- chore: auto-increment version for release
- feat: finalized bulletproof blueprint for nitro synchronization (v5.1.7)
- chore: auto-increment version for release
- feat: implemented dedicated polling thread for hardware state tracking (v5.1.6)
- chore: auto-increment version for release
- feat: deployed shadow hook for zero-ghosting movement (v5.1.5)
- chore: auto-increment version for release
- fix: resolved build errors in x-ray tracker implementation (v5.1.4)
- chore: auto-increment version for release
- feat: implemented x-ray physical tracker for bulletproof anti-ghosting (v5.1.3)
- chore: auto-increment version for release
- fix: added 10ms windows catch-up buffer to resolve ghosting (v5.1.2)
- chore: auto-increment version for release
- fix: resolved build errors and bumped to v5.1.1 for updater stability
- chore: auto-increment version for release
...
Generating release notes from commit range: v5.1.15..HEAD ### BetterAngle Pro v5.1.16
- Automated build release.

Generating release notes from commit range: v5.1.14..HEAD ### BetterAngle Pro v5.1.15
- Automated build release.

Generating release notes from commit range: v5.1.13..HEAD ### BetterAngle Pro v5.1.14
- Automated build release.

Generating release notes from commit range: v5.1.12..HEAD ### BetterAngle Pro v5.1.13
- Automated build release.

Generating release notes from commit range: v5.1.11..HEAD ### BetterAngle Pro v5.1.12
- Automated build release.

Generating release notes from commit range: v5.1.10..HEAD ### BetterAngle Pro v5.1.11
- Automated build release.
...
Generating release notes from commit range: v5.1.6..HEAD ### BetterAngle Pro v5.1.7
- Automated build release.

Generating release notes from commit range: v5.1.5..HEAD ### BetterAngle Pro v5.1.6
- Automated build release.

Generating release notes from commit range: v5.1.4..HEAD ### BetterAngle Pro v5.1.5
- Automated build release.

Generating release notes from commit range: v5.1.3..HEAD ### BetterAngle Pro v5.1.4
- Automated build release.

Generating release notes from commit range: v5.1.2..HEAD ### BetterAngle Pro v5.1.3
- Automated build release.

Generating release notes from commit range: v5.1.1..HEAD ### BetterAngle Pro v5.1.2
- Automated build release.

Generating release notes from commit range: v5.0.110..HEAD ### BetterAngle Pro v5.0.111
- Automated build release.

Generating release notes from commit range: v5.0.108..HEAD ### BetterAngle Pro v5.0.109
- Automated build release.

Generating release notes from commit range: v5.0.104..HEAD ### BetterAngle Pro v5.0.105
- Automated build release.

Generating release notes from commit range: v5.0.101..HEAD ### BetterAngle Pro v5.0.102
- Automated build release.

Generating release notes from commit range: v5.0.100..HEAD ### BetterAngle Pro v5.0.101
- Automated build release.

Generating release notes from commit range: v5.0.91..HEAD ### BetterAngle Pro v5.0.92
- Automated build release.

Generating release notes from commit range: v5.0.89..HEAD ### BetterAngle Pro v5.0.90
- Automated build release.

Generating release notes from commit range: v5.0.87..HEAD ### BetterAngle Pro v5.0.88
- Automated build release.

Generating release notes from commit range: v5.0.85..HEAD ### BetterAngle Pro v5.0.86
- Automated build release.
